 ...
 */
final class Version20220621092132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(40) DEFAULT NULL, prenom VARCHAR(50) DEFAULT NULL, telephone VARCHAR(30) DEFAULT NULL, etat TINYINT(1) DEFAULT NULL, sexe TINYINT(1) DEFAULT NULL, role VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
